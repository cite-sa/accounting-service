...
namespace Neanias.Accounting.Service.Query
{
	...
	public class ServiceResetEntrySyncQuery : Query<ServiceResetEntrySync>
	{
		...
		protected override IQueryable<ServiceResetEntrySync> ApplyAuthz(IQueryable<ServiceResetEntrySync> query)
		{
		...
		protected override IQueryable<ServiceResetEntrySync> ApplyFilters(IQueryable<ServiceResetEntrySync> query)
		{
