...
namespace Neanias.Accounting.Service.Query
{
	...
	public class TenantConfigurationQuery : Query<TenantConfiguration>
	{
		...
		protected override IQueryable<TenantConfiguration> ApplyFilters(IQueryable<TenantConfiguration> query)
		{
