...
namespace Cite.Accounting.Service.Service.ExternalIdentityInfoProvider
{
	...
	public class KeycloakIdentityInfoProviderService : IExternalIdentityInfoProvider
	{
		...
		private async Task<string> GetAccessToken()
		{
			...
			{
				Uri tokenUrl = new Uri($"{this._config.IdpBaseUtrl}/realms/{this._config.Realm}/protocol/openid-connect/token");
		...
		{
			Uri tokenUrl = new Uri($"{this._config.IdpBaseUtrl}/admin/realms/{this._config.Realm}/users/{id}");
