...
namespace Cite.Accounting.Service.IntegrationEvent.Inbox.Extensions
{
	public static class Extensions
	{
		public static IServiceCollection AddInboxIntegrationEventHandlers(this IServiceCollection services)
		{
			...
			services.AddTransient<IAccountingEntryCreatedIntegrationEventHandler, AccountingEntryCreatedIntegrationEventHandler>();
