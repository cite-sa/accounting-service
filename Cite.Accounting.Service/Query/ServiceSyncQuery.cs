...
namespace Cite.Accounting.Service.Query
{
	...
	public class ServiceSyncQuery : AsyncQuery<ServiceSync>
	{
		...
		protected override async Task<IQueryable<ServiceSync>> ApplyAuthzAsync(IQueryable<ServiceSync> query)
		{
		...
		protected override Task<IQueryable<ServiceSync>> ApplyFiltersAsync(IQueryable<ServiceSync> query)
		{
