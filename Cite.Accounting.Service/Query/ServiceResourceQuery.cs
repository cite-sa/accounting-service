...
namespace Cite.Accounting.Service.Query
{
	...
	public class ServiceResourceQuery : AsyncQuery<ServiceResource>
	{
		...
		protected override async Task<IQueryable<ServiceResource>> ApplyAuthzAsync(IQueryable<ServiceResource> query)
		{
		...
		protected override Task<IQueryable<ServiceResource>> ApplyFiltersAsync(IQueryable<ServiceResource> query)
		{
