...
namespace Cite.Accounting.Service.Query
{
	...
	public class WhatYouKnowAboutMeQuery : AsyncQuery<WhatYouKnowAboutMe>
	{
		...
		protected override Task<IQueryable<WhatYouKnowAboutMe>> ApplyFiltersAsync(IQueryable<WhatYouKnowAboutMe> query)
		{
