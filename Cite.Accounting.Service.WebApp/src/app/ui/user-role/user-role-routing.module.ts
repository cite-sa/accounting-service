...
import { UserRoleEditorEnityResolver } from './editor/resolvers/user-role-editor.resolver';
...
const routes: Routes = [
	...
	},
	{
		...
		canDeactivate: [PendingChangesGuard],
		resolve: {
			'entity': UserRoleEditorEnityResolver,
		}
	},
...
@NgModule({
	...
	providers: [UserRoleEditorEnityResolver],
})
