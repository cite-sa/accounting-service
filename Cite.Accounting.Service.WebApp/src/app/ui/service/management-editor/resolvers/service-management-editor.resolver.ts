...
@Injectable()
export class ServiceManagementEditorResolver extends BaseEditorResolver {
  ...
  resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot) {
    ...
    if (id != null) {
      return this.serviceService.getSingle(Guid.parse(id), ServiceManagementEditorResolver.serviceLookupFields()).pipe(takeUntil(this._destroyed))
