...
import { ServiceActionEditorEnityResolver } from './editor/resolvers/service-action-editor.resolver';
...
const routes: Routes = [
	...
	},
	{
		...
		canDeactivate: [PendingChangesGuard],
		resolve: {
			'entity': ServiceActionEditorEnityResolver,
		}
	},
...
@NgModule({
	...
	providers: [ServiceActionEditorEnityResolver],
})
