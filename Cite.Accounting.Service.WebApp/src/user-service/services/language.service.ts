...
export class LanguageService extends BaseService {
	...
	changeLanguage(language: LanguageType): void {
		...
		this.translate.use(this.languageValues.get(language));
	}
	
	getAvailableLanguageTypes(): LanguageType[] {
		return [...this.languageValues.keys()];
	}
	...
	getCurrentLanguageValue(): string {
		return this.languageValues.get(this.currentLanguage);
	}
