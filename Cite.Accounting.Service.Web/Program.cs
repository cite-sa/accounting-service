				...
				.ConfigureWebHostDefaults(webHostBuilder =>
					webHostBuilder.ConfigureAppConfiguration((hostingContext, config) =>
					{
						...
						config
							...
							//Prometheus
							.AddJsonFileInPaths("prometheus.json", sharedConfigPath, "Configuration")
							.AddJsonFileInPaths("prometheus.override.json", sharedConfigPath, "Configuration")
							.AddJsonFileInPaths($"prometheus.{env.EnvironmentName}.json", sharedConfigPath, "Configuration")
							//env
						...
						config.AddEnvironmentVariables("cite_accounting_");
