...
namespace Cite.Accounting.Service.Web.Authorization.Extensions
{
	public static class Extensions
	{
		public static IServiceCollection AddPermissionsAndPolicies(this IServiceCollection services, IConfigurationSection permissionsConfigurationSection)
		{
			...
			services.AddScoped<Cite.Accounting.Service.Authorization.IAuthorizationService, Cite.Accounting.Service.Web.Authorization.AuthorizationService>();
